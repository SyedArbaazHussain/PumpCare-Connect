  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (response.data.error) {
        ...
        navigate("/villager-login"); // Redirect to dashboard on successful signup
      }
    } catch (error) {
    ...
    <>
      ...
      <div className="wr">
        <div className="form-box">
          <h2 className="formh2">Villager Signup</h2>
          <form onSubmit={handleSignup} className="signupform">
            <div className="input-box">
              <label htmlFor="hno" className="icon">
                <ion-icon name="hno"></ion-icon>
              </label>
              <input
                type="text"
                id="hno"
                ...
                value={hno}
                onChange={(e) => {
                  const formattedHouseNumber = e.target.value
                    .replace(/\D/g, "")
                    .substring(0, 3); // Remove non-numeric characters and limit to 10 digits
                  setFormData({ ...formData, hno: formattedHouseNumber });
                }}
                required
                autoComplete="text"
              />
              <label htmlFor="cno">House Number</label>
            </div>
            <div className="input-box">
            ...
            <div className="login-register">
              <p>
                ...
                <Link to="/villager-login" className="register">
                  Login
                </Link>
              </p>
            </div>
...
export default VillagerSignupForm;
