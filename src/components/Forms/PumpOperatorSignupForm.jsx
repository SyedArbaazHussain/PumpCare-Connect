...
const PumpOperatorSignupForm = () => {
  ...
  const { name, cno, email, password } = formData;
  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (response.data.error) {
        ...
        navigate("/pump-operator-login"); // Redirect to dashboard on successful signup
      }
    } catch (error) {
      ...
      <div className="wr">
        <div className="wrapper">
          <div className="form-box">
            <h2 className="formh2">Pump Operator Signup</h2>
            <form onSubmit={handleSignup} className="signupform">
              ...
              <div className="login-register">
                <p>
                  ...
                  <Link to="/pump-operator-login" className="register">
                    Login
                  </Link>
                </p>
              </div>
...
export default PumpOperatorSignupForm;
